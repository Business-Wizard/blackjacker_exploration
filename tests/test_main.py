...
@pytest.fixture
def Deck_52_Counter():
    return Counter(4 * ['2', '3', '4', '5', '6', '7', '8', '9', '10', 'Jack', 'Queen', 'King', 'Ace'])

@pytest.fixture
def Deck_52_List():
    return 4 * ['2', '3', '4', '5', '6', '7', '8', '9', '10', 'Jack', 'Queen', 'King', 'Ace']
...
def test_shuffled_same_length(Deck_52):
    ...
    assert Counter(original) == Counter(shuffled), "Deck.shuffle has added/removed cards"
